...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/css/flaticon.css" type="text/css">
                    ...
                    <div class="header__menu__option">
                        <nav class="header__menu">
                            <ul>
                                ...
                                <li><a href="#">Login</a>
                                    <ul class="dropdown">
                                        <li><a href="<?php echo e(route('login')); ?>">Patient</a></li>
                                        <li><a href="<?php echo e(route('doctor.login')); ?>">Doctor</a></li>
                        ...
                        <div class="header__btn">
                            <a href="<?php echo e(route('register')); ?>" class="primary-btn">Register</a>
                        </div>
                        <?php endif; ?>
...
<?php /**PATH F:\PHP Development\Laravel\mY-project\mentalHealthSolution\resources\views/frontend/master.blade.php ENDPATH**/ ?>